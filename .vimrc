...
" Plugins {
    ...
    " OmniComplete {
        ...
        if !exists('g:vim_no_omni_complete')
            ...
            if exists('g:vim_map_cr_omni_complete')
    ...
    " neocomplete {
        if count(g:vim_bundle_groups, 'neocomplete')
            let g:acp_enableAtStartup = 0
            ...
            " Plugin key-mappings {
                ...
                if !exists('g:vim_no_neosnippet_expand')
                    imap <C-k> <Plug>(neosnippet_expand_or_jump)
                    smap <C-k> <Plug>(neosnippet_expand_or_jump)
                endif
                if exists('g:vim_noninvasive_completion')
                    inoremap <CR> <CR>
    ...
    " }
    " neocomplcache {
        elseif count(g:vim_bundle_groups, 'neocomplcache')
            let g:acp_enableAtStartup = 0
    ...
    " To disable omni complete, add the following to your .vimrc.before.local file:
    "   let g:vim_no_omni_complete = 1
        elseif !exists('g:vim_no_omni_complete')
            " Enable omni-completion.
            autocmd FileType css setlocal omnifunc=csscomplete#CompleteCSS
            autocmd FileType html,markdown setlocal omnifunc=htmlcomplete#CompleteTags
            autocmd FileType javascript setlocal omnifunc=javascriptcomplete#CompleteJS
    ...
    " Snippets {
        if count(g:vim_bundle_groups, 'neocomplcache') ||
                    \ count(g:vim_bundle_groups, 'neocomplete')
